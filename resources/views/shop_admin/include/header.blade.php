                        ...
                        <span id="logged-in-state" class="me-5">
                            <div class="dropdown  ">
                                ...
                                @if(Auth::user()->role_id == 2)
                                    ...
                                    @if(Auth::user()->image == null)
                                        <img src="{{ asset('img/profile-image.jpg') }}"
                                            ...
                                            aria-expanded="false">
                                    @else
                                    <img src="{{ asset('uploads/shop/profile/'.Auth::user()->image) }}"
                                    class="rounded-circle header-profile-img" alt="..."
                                    id="dropdownMenuButton1" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    @endif
                                ...
                                <ul class="dropdown-menu menu-show" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li>
                                        @if(Auth::user()->role_id == '2')
                                        <a class="dropdown-item" href="{{route('shop_profile')}}">
                                            My Profile
                                        </a>
                                        <a class="dropdown-item" href="{{route('shop_work_hour')}}">
                                            Work Hour
                                        </a>
                                        @else
                                        <a class="dropdown-item" href="{{route('individual_profile')}}">
                                            My Profile
                                        </a>
                                        @endif
                                    </li>
