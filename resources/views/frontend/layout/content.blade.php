    ...
    <div class="px-4 py-5 my-5 text-center mx-auto ">
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center ">
                <button type="button" class=" shadow border border-dark custom-border-radius-1 custom-hover-1  p-1 btn-lg px-4 gap-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">Get Started</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row mt-5 align-items-center shadow">
            <div class="col-lg-3 col-md-3 col-sm-12 col-12 pb-5">
                <img class="service align-center x  " src="https://d2zdpiztbgorvt.cloudfront.net/region1/us/61845/biz_photo/425455aac8cd45ce8a03c08983ace9-modern-classics-grooming-loung-biz-photo-ee96610550a1475ca020b00cf5969a-booksy.jpeg?fbclid=IwAR0bQG7i4B3T2ObEAacFQtYHuAtUkc17b7c_uql4pbTsImipQEr3dpQ4skg" alt="" width="200px" height="200px">
            </div>
...
<section class="mt-5" data-aos="zoom-in-up">
    <div class="container">
        ...
        <div class="row mt-5 align-items-center shadow">
            <div class="col-lg-3 col-md-3 col-sm-12 col-12 pb-5">
                <img class="service align-center x  " src="https://images.unsplash.com/photo-1605497788044-5a32c7078486?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80" alt="" width="200px" height="200px">
            </div>
            <div class="col-lg-9 col-md-9 col-sm-12 col-12 ">
                <div class="row align-middle shop_list">
...
<section class="container-fluid pt-5 section-one">
    ...
    <div class="  pt-5 d-flex justify-content-xxl-around justify-content-xl-around justify-content-lg-around justify-content-md-around justify-content-sm-around  justify-content-around mx-5 my-4">
