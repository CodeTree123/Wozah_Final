                        ...
                        <div class="{{old('verify') ? 'd-none': 'row g-3'}} ">
                            ...
                            <div class="form-floating mb-3">
                                <div class="input-group "  >
                                    <input type="password" class="form-control new-form-control password_input" name="password" id="cPassword"
                            ...
                            <div class="form-floating mb-3">
                                <div class="input-group" >
                                    <input type="password" class="form-control new-form-control password_input" name="password_confirmation" id="cConfirmPassword"
                        ...
                        @if(old('verify'))
                            ...
                            @if (Session::has('otp_msg'))
                                <div class="alert alert-success">
                                    <p class="mb-0">{!! Session::get('otp_msg') !!}</p>
                                </div>
                            @endif
