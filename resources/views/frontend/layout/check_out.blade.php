          ...
          <div class="row g-3">
            ...
            <!-- <div class="col-12 border border-dark pb-2">
              <div class="row g-3 ">
                ...
                <div class="col-6">
                    <label for="c_street_name" class="form-label">Street Name</label>
                    <input type="text" class="form-control" name="customer_street_name" value="sdf" id="c_street_name">
                </div>
                <div class="col-6">
                    <label for="c_street_number" class="form-label">Street Number</label>
                    <input type="number" class="form-control" name="customer_street_number" value="" id="c_street_number">
                </div>
                <div class="col-3">
                    <label for="c_apartment_no" class="form-label">Apt#</label>
                    <input type="text" class="form-control" name="customer_apt" value="" id="c_apartment_no">
                </div>
                <div class="col-3">
                    <label for="c_city" class="form-label">City</label>
                    <input type="text" class="form-control" name="customer_city" value="" id="c_city">
                </div>
                <div class="col-3">
                    <label for="c_state" class="form-label">State</label>
                    <input type="text" class="form-control" name="customer_state" value="" id="c_state">
                </div>
                <div class="col-3">
                    <label for="c_zip" class="form-label">Zip</label>
                    <input type="number" class="form-control" name="customer_zip" value="" id="c_zip">
                </div>
              </div>
            </div> -->
