...
<ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <a class="nav-link {{request()->is('shopr') ? 'active': '' }} " href="{{url('/shopr')}}" role="tab" aria-controls="home" aria-selected="true">Shop Revenue</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link {{request()->is('individualr') ? 'active': '' }}" href="{{url('/individualr')}}" role="tab" aria-controls="profile" aria-selected="false">Individual Revenue</a>
    </li>
</ul>
<div class="tab-content mt-2" id="myTabContent">
    <div class="tab-pane {{request()->is('shopr') ? 'active': '' }} table-responsive" id="{{url('/shopr')}}" role="tabpanel" aria-labelledby="home-tab">
    ...
    <div class="tab-pane {{request()->is('individualr') ? 'active': '' }} table-responsive" id="{{url('/individualr')}}" role="tabpanel" aria-labelledby="profile-tab">
