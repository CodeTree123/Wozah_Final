...
//        $individuals = individual_info::Join('Users','individual_infos.u_id','=','users.id')->get(['individual_infos.*','users.first_name','users.last_name','users.phone','users.email','users.image']);
        ...
        $individuals = User::where('role_id','3')->where('emp_status','0')->where('user_status','1')->get();
//         dd($shops,$individuals);
    ...
    {
        $list=User::leftJoin('customer_infos','Users.id','=','customer_infos.u_id')->where('users.id', auth()->id())
                    ->first(['Users.first_name','Users.last_name','Users.phone','Users.email','customer_infos.*']);
