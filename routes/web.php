...
Route::get('/shopr',[AdminController::class,'revenue_shop'])->name('revenue_shop')->middleware('auth');
Route::get('/individualr',[AdminController::class,'revenue_individual'])->name('revenue_individual')->middleware('auth');
